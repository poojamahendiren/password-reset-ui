...
export function Login({setLoading,setVerified}){
   ...
   const navigate = useNavigate(); // to change the end-points and move to other pages
    ...
    return(
        <form className="loginForm" onSubmit={handleSubmit}>
            ...
            <div className="loginAnchorsDiv">
                <button type="button" className="loginAnchors" onClick={()=>navigate("/forgot_Password")}>Forgot Password?</button>
                <button type="button" className="loginAnchors" onClick={()=>navigate("/Signup")}>New User?</button>
            </div>
        </form>
    )
};